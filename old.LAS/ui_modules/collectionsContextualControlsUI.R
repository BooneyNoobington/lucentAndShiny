### ------------------------------------------------------------------------------------------------
### --- UI specifically for collection class buttons -----------------------------------------------
### ------------------------------------------------------------------------------------------------



DrawCollectionClassBtns <- function(id) {
    ...
    div_wrapper <- shiny::div(
      ...
      , shiny::actionButton(ns("sql_info"), NULL, shiny::icon("database"))
        # Add a horizontal spacer to separate default and contextual contrls.
      , shiny::actionButton(ns("add_collection_class"), "Add Collection Class", shiny::icon("tags"))
      , shiny::actionButton(ns("add_object"), "Add Object", shiny::icon("magnifying-glass"))
      , shiny::actionButton(ns("add_matrix"), "Add Matrix", shiny::icon("water"))
